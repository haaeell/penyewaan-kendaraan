                    ...
                    <div class="row">
                        @foreach($kendaraans as $kendaraan)
                            <div class="col-md-4 mb-4">
                                <div class="d-flex align-items-center p-2 rounded-3 shadow-md" style="border: 1px solid rgb(248, 190, 0)">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <a href="{{ route('detailKendaraan', $kendaraan->id) }}" class="btn btn-warning text-white w-100 btn-sm">Lihat Detail</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
