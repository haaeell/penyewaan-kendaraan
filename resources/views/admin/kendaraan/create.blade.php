    ...
    <div class="col-md-12">
        ...
        <div class="card shadow border-0">
            <div class="card-header">
                <h4 class="fw-semibold text-primary">{{ __('Tambah Kendaraan') }}</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="plat_nomor" name="plat_nomor" class="form-control @error('plat_nomor') is-invalid @enderror" value="{{ old('plat_nomor') }}" required>
                                @error('plat_nomor')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="tahun" name="tahun" class="form-control @error('tahun') is-invalid @enderror" value="{{ old('tahun') }}" required>
                                @error('tahun')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-3" id="seating_capacity_div">
                            <div class="form-group">
                                ...
                                <input type="number" id="seating_capacity" name="seating_capacity" class="form-control @error('seating_capacity') is-invalid @enderror" value="{{ old('seating_capacity') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="merk" name="merk" class="form-control @error('merk') is-invalid @enderror" value="{{ old('merk') }}" required>
                                @error('merk')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary text-white">{{ __('Simpan') }}</button>
